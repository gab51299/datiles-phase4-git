...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { email: @personal.email, idtype: @personal.idtype, mobile: @personal.mobile, rewardtype: @personal.rewardtype, tel: @personal.tel } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { email: @personal.email, idtype: @personal.idtype, mobile: @personal.mobile, rewardtype: @personal.rewardtype, tel: @personal.tel } }
